...
beta_stack1=linspace(start_beta,end_beta,31);
...
out_niubi=zeros(size(beta_stack,2),1);
out_niubi2=zeros(size(beta_stack,2),1);
...
out_niubi(i_b)=out_sum(i_a,i_f,i_b,1);
%     %% 中段形变
...
%         %% 管道半径
        ...
        out_niubi2(i_b)=out_sum(i_a,i_f,i_b,3);
...
p0=plot(beta_stack1',out_niubi,'-')
hold on;
%
p1=plot(beta_stack1(1,1,1),out_hu(1),'.','Markersize',11,'Color',[0 0 0])
text(beta_stack1(1,1,1),out_hu(1),'F1','FontSize',14);

p2=plot(beta_stack1(1+15),out_hu(1,1,1+15),'.','Markersize',11,'Color',[0 0 0])
text(beta_stack1(1+15),out_hu(1,1,1+15),'F2','FontSize',14);

p3=plot(beta_stack1(1+15+15),out_hu(1,1,1+15+15),'.','Markersize',11,'Color',[0 0 0])
text(beta_stack1(1+15+15),out_hu(1,1,1+15+15),'F3','FontSize',14);
...
p00=plot(beta_stack1,out_niubi2,'--')
hold on;
%
p4=plot(beta_stack1(1,1,1),out_sum(1,1,1,3),'.','Markersize',11,'Color',[0 0 0])
text(beta_stack1(1,1,1),out_sum(1,1,1,3),'F1','FontSize',14);

p5=plot(beta_stack1(1+15),out_sum(1,1,1+15,3),'.','Markersize',11,'Color',[0 0 0])
text(beta_stack1(1+15),out_sum(1,1,1+15,3),'F2','FontSize',14);

p6=plot(beta_stack1(1+15+15),out_sum(1,1,1+30,3),'.','Markersize',11,'Color',[0 0 0])
text(beta_stack1(1+15+15),out_sum(1,1,1+30,3),'F3','FontSize',14);
legend([p0 p00],{'软轴长度','弯曲半径'},'location','northwest'); 
% p0=plot(beta_stack1',out_niubi,'-')
% legend(p0,3)
