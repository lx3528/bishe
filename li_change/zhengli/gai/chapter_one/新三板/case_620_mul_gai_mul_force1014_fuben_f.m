...
start_f=20/2.8679;
end_f=20*3/2.8679;
f_stack=linspace(start_f,end_f,31);
ei=1;
%% 改变beta
...
%% 画弧长
f_stack=f_stack*2.8679;
p0=plot(f_stack,out_hu','-')
hold on;
%
p1=plot(f_stack(1,1,1),out_hu(1),'.','Markersize',11,'Color',[0 0 0])
text(f_stack(1,1,1),out_hu(1),'F1','FontSize',14);

p2=plot(f_stack(1+15),out_hu(1,1+15,1),'.','Markersize',11,'Color',[0 0 0])
text(f_stack(1+15),out_hu(1,1+15,1),'F2','FontSize',14);

p3=plot(f_stack(1+15+15),out_hu(1,1+15+15,1),'.','Markersize',11,'Color',[0 0 0])
text(f_stack(1+15+15),out_hu(1,1+15+15,1),'F3','FontSize',14);
...
p00=plot(f_stack,out_sum(1,:,1,3)','--')
hold on;
%
p4=plot(f_stack(1,1,1),out_sum(1,1,1,3),'.','Markersize',11,'Color',[0 0 0])
text(f_stack(1,1,1),out_sum(1,1,1,3),'F1','FontSize',14);

p5=plot(f_stack(1+15),out_sum(1,1+15,1,3),'.','Markersize',11,'Color',[0 0 0])
text(f_stack(1+15),out_sum(1,1+15,1,3),'F2','FontSize',14);

p6=plot(f_stack(1+15+15),out_sum(1,1+30,1,3),'.','Markersize',11,'Color',[0 0 0])
text(f_stack(1+15+15),out_sum(1,1+30,1,3),'F3','FontSize',14);
